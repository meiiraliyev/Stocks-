...
//import UIKit
//
//class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, StocksCellDelegate {
//
...
//
//        if toShowFavourites {
//            cell.ticker = favStocks[indexPath.row]
//        } else {
//            cell.ticker = stocks[indexPath.row]
//        }
//        if favStocks.contains(cell.ticker ?? "ticker"){
